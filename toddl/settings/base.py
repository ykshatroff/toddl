"""
Django settings for toddl project.
...
ADMINS = (
    ('Admins', 'info@toddl.ee'),
)
MANAGERS = ADMINS
EMAIL_SUBJECT_PREFIX = '[toddl] '  # subject prefix for managers & admins

SESSION_COOKIE_NAME = 'toddl_ssid'
...
ROOT_URLCONF = 'toddl.urls'

WSGI_APPLICATION = 'toddl.wsgi.application'
...
# Email config
DEFAULT_FROM_EMAIL = "toddl <info@toddl.ee>"
SERVER_EMAIL = "toddl server <server@toddl.ee>"
