...
Browser support is defined in the `toddl/browserslist` file that is used for autoprefixing CSS.
...
|run psql                           |`make psql`                        |`docker-compose exec postgres psql --user toddl --dbname toddl` |


## Running commands on the server

    docker-compose -f docker-compose.production.yml run --rm --name toddl_tmp django python manage.py <command>
